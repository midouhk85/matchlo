...
/** Onglets de l'espace entreprise. */
export default function CompanyLayout() {
  ...
  return (
    ...
    >
      <Tabs.Screen
        name="candidates"
        options={{ title: t('tabs.candidates'), tabBarIcon: ({ color }) => <Icon e="🔥" color={color} /> }}
      />
      <Tabs.Screen
        name="matches"
      ...
      <Tabs.Screen
        name="ads"
        options={{ title: t('tabs.ads'), tabBarIcon: ({ color }) => <Icon e="📢" color={color} /> }}
      />
      <Tabs.Screen
        name="profile"
